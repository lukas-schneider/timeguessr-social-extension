...
import { getSettings, updateSettings } from "../src/utils/extension.utils";
import { ApiEndpoint, ApiMessage } from "../src/types/extension.types";
...
export default defineBackground(() => {
  async function migrateServerUrl() {
    ...
    if (serverUrl && !groupId) {
      const oldUrl =
        "https://qnzjnny2ch.execute-api.eu-central-1.amazonaws.com/";
